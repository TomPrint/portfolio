...
const Contact = () => {
  return (
    <div name='contact' className='mx-auto p-4 w-full h-screen  bg-[#202020] text-gray-300 flex justify-center items-center'>
        ...
        <form method='POST'action="https://getform.io/f/98604098-8074-4869-9eae-7b3fc6c51f64" className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-10'>
                ...
                <p className='text-gray-300 flex py-4'>
                <span>
            ...
            <textarea rows='10' placeholder='Message' name='message' className='w-full p-4 border-b-4 border-amber-300 text-gray-700'/>
            <button className='text-white border-2 hover:border-amber-300 px-4 py-3 mx-auto flex items-center mt-2'>Send The Message</button>
        </form>
